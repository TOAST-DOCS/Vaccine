...
* Vaccine 使用時に必要な管理サーバーの運用、ポリシー設定、例外処理などの業務を無料で利用できます。
* ワクチンイベント探知の状況情報をサービスコンソール画面で確認できます。
* ワクチンイベント探知の状況情報をメールで受信できます。
* Windows および Linux OS をサポートします。
* 探知されたマルウェアは遮断および隔離します。
* 悪性Webサイトへのアクセスを遮断します。
* リアルタイム検査および手動スキャン機能を利用できます。
* 最新探知パターンアップデートを利用できます。
