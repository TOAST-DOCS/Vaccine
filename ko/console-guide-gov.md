...
공인 망에서의 백신 서버와 통신하려면 서버 보안 그룹에 아래 내용을 추가합니다. (외부 통신이 가능한 에이전트들 대상)
...
사설 망에서의 백신 서버와 통신하려면 서버 보안 그룹에 아래 내용을 추가합니다. (공공 Private - 하이브리드망 / 2차 방화벽 사용 필수)
사설 망에서의 통신은 Red Zone 방화벽, 라우팅 추가가 필요합니다. 설정에 대한 자세한 내용은 1:1 문의 부탁드립니다.
