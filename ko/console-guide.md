...
| 방향 | 포트 | 리전 | CIDR |
| --- | --- | --- | ---- |
| Egress | 4119, 4120, 4122 | 한국(판교), 한국(평촌) | 106.249.21.88/32 |
...
* Linux
   1. vi 편집기 등으로 /etc/hosts 파일에 아래 내용을 추가합니다.
   2. 10.162.255.105 vaccine-private.gov-nhncloud.com

* Windows
   1. 메모장을 관리자 권한으로 실행 합니다.
   2. 실행 후 [파일 > 열기] 를 클릭합니다.
   3. C:\Windows\System32\drivers\etc 경로의 hosts 파일을 불러와 아래 내용을 추가합니다.
   4. 10.162.255.105 vaccine-private.gov-nhncloud.com
